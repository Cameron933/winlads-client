          ...
          <div className="flex flex-col lg:flex-row  flex-1 mx-5 gap-5">
            ...
            <div className="flex flex-col flex-1 gap-5">
              ...
              <div className="flex flex-col gap-4  lg:flex-row lg:items-end lg:mt-10">
                ...
                <div className="flex flex-col gap-4  lg:flex-row  lg:justify-center lg:mt-5 flex-wrap">
...
function PopUpLotto({ onClose }) {
  ...
  return (
    <div
      className="popup-container backdrop backdrop-blur-sm lg:justify-end justify-center hover:cursor-pointer hover:shadow-lg"
    ...
    >
      <div className=" popup-content bg-gradient-to-br  from-[#D65252] space-y-4  to-[#404040]  justify-center items-center py-2  xl:px-20 md:px-20 px-10 paymentCardBorder flex flex-col lg:mr-[10%]">
        ...
        <div className="flex justify-center gap-5 bg-black p-4 rounded-xl mt-3 px-12 cursor-pointer hover:bg-[#C45050]">
          <button><img src={wallet} alt="" className="w-7 h-7 hover:scale-105" /></button>
          <button><img src={savelotto} alt="" className="w-7 h-7 hover:scale-105" /></button>
          <button> <img src={bitcoin} alt="" className="w-7 h-7 hover:scale-105" /></button>
...
function PopUpLess({ onClose }) {
  ...
  return (
    <div
      className="popup-container backdrop2 backdrop-blur-sm lg:justify-end justify-center hover:cursor-pointer hover:shadow-lg"
    ...
    >
      <div className=" popup-content bg-gradient-to-br from-[#D65252] to-[#404040] justify-center items-center py-2 paymentCardBorder flex flex-col md:px-20 xl:px-20 px-10 lg:mr-[10%]">
        ...
        <button
          type="button"
          className="border border-black bg-black text-[#D65252] py-2 px-8 rounded-lg mt-4 mb-2 hover:text-white hover:bg-[#C45050]"
        >
          Confirm
        </button>
      </div>
