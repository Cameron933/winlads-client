                        ...
                        <div className="flex flex-col space-y-3">
                            {loading ? (
                                ...
                                < div className="mt-20 flex flex-col space-y-5">
                                    ...
                                    <div className="flex flex-col space-y-5 special:space-y-5">
                                        ...
                                        <div className="w-full">
                                            <img src="/src/assets/images/banner-1.png" className="w-8/12 mr-auto h-full object-contain" />
                                        </div>
                                        ...
                                        <div className="w-full h-32">
                                            <img src="/src/assets/images/banner-2.png" className="w-full h-full object-contain" />
                                        </div>
                                        <div className="flex flex-col space-y-2">
                                            <p className="text-black text-sm xl:text-md special:text-xl">
                                                Banner (250*250)
                                        ...
                                        <div className="w-32 h-32 mr-auto">
                                            <img src="/src/assets/images/banner-3.png" className="w-full h-full object-contain" />
                                        </div>
                                    </div>
                                </div>
