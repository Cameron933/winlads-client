    ...
    <div className="flex relative min-h-screen w-full overflow-hidden">
      ...
      <div className="xl:flex xl:flex-row flex-col xl:justify-between flex-1 mx-5 xl:gap-4 pb-5 space-y-4 xl:space-y-0">
        ...
        <div className="left-side flex flex-col space-y-4 flex-1">
          ...
          {/* <SearchField /> */}
          <h1 className="font-bold text-xl special:text-4xl 2xl:text-2xl">News</h1>
          {loading ? (
            ...
            <div className="flex flex-col space-y-4 special:pt-16 2xl:pt-8 xl:pt-8 pt-4 2xl:space-y-6">
              ...
              {
                newsList.length > 5 && (initialShow == 6 ? <button onClick={() => handleSeeMore(true)}>See More</button> : <button onClick={() => handleSeeMore(false)}>See Less</button>)
              }
            </div>
          ) : (
