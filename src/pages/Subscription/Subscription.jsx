        ...
        <div className="flex relative min-h-screen">
          ...
          <div className="xl:flex xl:flex-row flex-col xl:justify-between px-4 special:px-12 2xl:px-8 flex-1 xl:gap-4 special:gap-8 2xl:gap-6 space-y-4 xl:space-y-0">
            ...
            <div className="flex flex-col space-y-4 flex-1 special:space-y-8 2xl:space-y-6">
              ...
              <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 special:gap-6 2xl:gap-4 ${choosePlane=="true ? bg-white/50"}`}>
                {planes.map((plane, key) => (
                  <SubscribeCard
                    ...
                    buttonColor={plane.name == "Standard" ? "white" : "black"}
                    buttonText={plane.name == "Standard" ? "black" : "white"}
                    buttonHover={plane.name == "Standard" ? "black" : "white"}
                    buttonHoverText={
                    ...
                    raffleCount={
                      isYearly ? plane.raffle_count_annual : plane.raffle_count
                    }
