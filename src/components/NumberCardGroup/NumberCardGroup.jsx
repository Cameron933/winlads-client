    ...
    <div className="mx-auto p-4">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="grid-cols-3 md:grid-cols-1 mb-2 ">
          <div className="card p-5 mb-5  hover-up">
            <div className="card-body ">
              <img className="icon" src={add} alt="saving"></img>
              <h1 className="N-tittle text-white">600+</h1>
          ...
          <div className="card p-5 mt-5 md:mt-0  mb-5 hover-up">
            <div className="card-body">
              <img className="icon" src={home} alt="saving"></img>
              <h1 className="N-tittle text-white">1000s</h1>
              <p className="card-text text-white">
