  ...
  return (
    <div className="container mx-auto p-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-2">
        <div className="bg-gradient-to-br justify-center items-center from-[#37DBFF] to-[#00819D] py-2 px-4 rounded-3xl flex flex-col hover:shadow-md hover:cursor-pointer">
          ...
          <button
            type="button"
            className=" bg-gray-800 text-[#37DBFF] py-2 px-8 rounded-lg text-sm mt-4 mb-2 hover:bg-[#2AC6E9] hover:text-black hover:shadow-md"
        ...
        <div className="bg-gradient-to-br from-[#FF9F9F] to-[#D04D4D] justify-center items-center py-2 px-4 rounded-3xl flex flex-col hover:shadow-md hover:cursor-pointer">
          <div className="flex justify-center mb-2">
            <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1">
          ...
          <button
            type="button"
            className=" bg-gray-800 text-[#FF9F9F] py-2 px-8 rounded-lg text-sm mt-4 mb-2 hover:bg-[#F38A8A] hover:text-black hover:shadow-sm"
        ...
        <div className="bg-gradient-to-br from-[#47FF37] to-[#169D00] justify-center items-center py-2 px-4 rounded-3xl flex flex-col hover:shadow-md hover:cursor-pointer">
          <div className="flex justify-center mb-2">
            <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1">
          ...
          <button
            type="button"
            className=" bg-gray-800 text-[#47FF37] py-2 px-8 rounded-lg text-sm mt-4 mb-2 hover:bg-[#3CE92B] hover:text-black hover:shadow-sm"
        ...
        <div className="bg-gradient-to-br from-[#FFDF37] to-[#9D7C00] justify-center items-center py-2 px-4 rounded-3xl flex flex-col hover:shadow-md hover:cursor-pointer">
          <div className="flex justify-center mb-2">
            <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1">
          ...
          <button
            type="button"
            className=" bg-gray-800 text-[#FFDF37] py-2 px-8 rounded-lg text-sm mt-4 mb-2 hover:bg-[#E8C82A] hover:text-black hover:shadow-sm"
...
function PopUpSubscribeBlue({ onClose }) {
  ...
  return (
    <div
      className="subCard fixed top-0 left-0 w-full h-full flex justify-center lg:justify-start items-center  bg-opacity-50  backdrop-blur-sm"
      onClick={handleBackdropClick}
    >
      <div className=" popup-content bg-gradient-to-br  from-[#37DBFF] to-[#00819D] items-center xl:px-12 rounded-3xl flex flex-col lg:ml-[18%]">
        ...
        <div className="flex justify-center gap-5 bg-black p-4 rounded-xl mt-3 px-12 hover:bg-[#2AC6E9]">
          <button> <img src={wallet} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
          <button> <img src={savelotto} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
          <button> <img src={bitcoin} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
        </div>
      </div>
    </div>
  );
...
function PopUpSubscribeRed({ onClose }) {
  ...
  return (
    <div
      className="subCard2 fixed top-0 left-0 w-full h-full flex justify-center lg:justify-start items-center  bg-opacity-50  backdrop-blur-sm"
      onClick={handleBackdropClick2}
    >
      <div className=" popup-content bg-gradient-to-br  from-[#FF9F9F] to-[#D04D4D]  items-center xl:px-12 rounded-3xl flex flex-col lg:ml-[18%]  ">
        <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1 mb-2">
          <p className="text-black">Bronz</p>
        </div>
        <p className="font-bold text-black text-center text-5xl mb-1 mt-1">
        ...
        <div className="flex justify-center gap-5 bg-black p-4 rounded-xl mt-3 px-12 hover:bg-[#F38A8A]">
          <button>
            <img src={wallet} alt="" className="w-7 h-7 cursor-pointer hover:scale-105 "   />
          </button>
          <button>
            <img src={savelotto} alt="" className="w-7 h-7 cursor-pointer hover:scale-105 "   />
          </button>
          <button>
            <img src={bitcoin} alt="" className="w-7 h-7 cursor-pointer hover:scale-105 "   />
          </button>
        </div>
      </div>
    </div>
...
function PopUpSubscribeGreen({ onClose }) {
  ...
  return (
    <div
      className="subCard3 fixed top-0 left-0 w-full h-full flex justify-center lg:justify-start items-center  bg-opacity-50  backdrop-blur-sm"
      onClick={handleBackdropClick3}
    >
      <div className=" popup-content bg-gradient-to-br  from-[#47FF37] to-[#169D00]   items-center xl:px-12 rounded-3xl flex flex-col lg:ml-[18%] ">
        <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1 mb-2">
          <p className="text-black">Standard</p>
        </div>
        <p className="font-bold text-black text-center text-5xl mb-1 mt-1">
        ...
        <div className="flex justify-center gap-5 bg-black p-4 rounded-xl mt-3 px-12 hover:bg-[#3CE92B]">
          <button> <img src={wallet} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
          <button> <img src={savelotto} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
          <button> <img src={bitcoin} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
        </div>
...
function PopUpSubscribeYellow({ onClose }) {
  ...
  return (
    <div
      className="subCard4 fixed top-0 left-0 w-full h-full flex justify-center lg:justify-start items-center  bg-opacity-50  backdrop-blur-sm"
      onClick={handleBackdropClick3}
    >
      <div className=" popup-content bg-gradient-to-br  from-[#FFDF37] to-[#9D7C00] items-center xl:px-12 rounded-3xl flex flex-col lg:ml-[18%] ">
        <div className="border-2 w-26 text-center border-black rounded-xl px-4 py-1 mb-2">
          <p className="text-black">Gold</p>
        </div>
        <p className="font-bold text-black text-center text-5xl mb-1 mt-1">
        ...
        <div className="flex justify-center gap-5 bg-black p-4 rounded-xl mt-3 px-12  hover:bg-[#E8C82A">
          <button> <img src={wallet} alt="" className="w-7 h- cursor-pointer hover:scale-105" /></button>
          <button> <img src={savelotto} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
          <button> <img src={bitcoin} alt="" className="w-7 h-7 cursor-pointer hover:scale-105" /></button>
