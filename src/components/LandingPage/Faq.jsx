    ...
    return (
        <div className='bg-chose-plan py-1 px-1 md:px-0' id='faq'>
                    ...
                    />
                    {
                        showAll && <>
                            ...
                            <FaqItem
                                ...
                                desc={'The promotion is valid in all states of Australia excluding South Australia.'}
                            />
                        </>
                    }
                </div>
                    ...
                    />
                    {
                        ...
                        By participating, you can earn commissions on the subscription fees of individuals you refer. Additionally, you contribute to expanding our community and potentially increasing your passive income.`}
                            ...
                            <FaqItem
                                ...
                                desc={'If you take the cash it is completely tax free! How good is that!'}
                            />
                            <FaqItem
            ...
            <div className='w-full text-center my-4'>
                <button onClick={() => setShowAll((prev) => !prev)} className=' font-semibold text-xs md:text-lg lg:text-xl -translate-x-1/3 hover:text-cyan-600'>{showAll ? 'Show less' : 'Show all'}</button>
            </div>
        </div>
    )
}
