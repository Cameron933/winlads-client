...
function header() {
  ...
  return (
    <header className={`fixed w-full ${scrolling ? 'bg-black' : 'bg-transparent'}`}>
      <nav
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-lg font-bold leading-7 text-gray-900 hover:bg-gray-50">
                        Benifits
                        <ChevronDownIcon
