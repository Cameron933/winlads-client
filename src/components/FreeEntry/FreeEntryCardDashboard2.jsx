...
const FreeEntryCardDashboard2 = () => {
  const handleClickButton = () => {
    window.location.href = "https://winlads.com/register?COUPEN=WINFREE";
  };

  return (
    <div className="rounded-[10px] md:w-full md:h-full w-[220px]  shadow-lg bg-[#F7B928] shadow-gray-400 relative flex flex-col ">
      ...
      <div className="absolute bottom-2 left-0 right-0 mx-2 flex justify-center ">
        ...
        >
          TWO <span className="font-bold text-lg">WEEK</span> ONLY
        </div>
      </div>
    </div>
  );
...
export default FreeEntryCardDashboard2;
